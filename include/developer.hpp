#ifndef DEVELOPER_HPP_FJFSUBGBTBITDAD
#define DEVELOPER_HPP_FJFSUBGBTBITDAD
...
/// @param dev
/// @return std::ostream&;
auto operator<<(std::ostream& stream, const Developer& dev) -> std::ostream&;
...
class SeniorDeveloper : public Developer
{
   public:
    ...
    virtual void solve_problem()
        const override;  // Implementation of the solve_problem method for the SeniorDeveloper class
};
...
class JuniorDeveloper : public Developer
{
   public:
    ...
    virtual void solve_problem()
        const override;  // Implementation of the solve_problem method for the JuniorDeveloper class
};
